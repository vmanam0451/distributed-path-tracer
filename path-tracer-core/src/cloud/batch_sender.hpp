...
class batch_sender {
    public:
    batch_sender(const std::string &topic_arn, const std::string &source_worker_id, 
        size_t batch_size = 1000, std::chrono::milliseconds flush_interval = std::chrono::milliseconds(50))
